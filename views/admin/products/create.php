...
<form action="" method="post" enctype="multipart/form-data">
    <div class="form-group mb-3">
        <label class="form-label" for="category_id">Chọn danh mục <span class="text-danger">*</span></label>
    ...
    <div class="form-group mb-3">
        <label class="form-label" for="title">Nhập tên sản phẩm <span class="text-danger">*</span></label>
        <input type="text" name="name" value="<?php echo isset($_POST['name']) ? htmlentities($_POST['name']) : '' ?>"
    ...
    <div class="form-group mb-3">
        ...
        <input type="number" name="cost" value="<?php echo $_POST['cost'] ?? '' ?>"
    ...
    <div class="form-group mb-3">
        ...
        <input type="number" name="price" value="<?php echo $_POST['price'] ?? '' ?>"
    ...
    <div class="form-group mb-3">
        ...
        <textarea name="description" id="description"
                  class="form-control"><?php echo isset($_POST['description']) ? htmlentities($_POST['description']) : '' ?></textarea>
    </div>
